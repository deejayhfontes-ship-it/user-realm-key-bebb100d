...
import { Building2, ArrowLeft, Wrench, Image, FileText, Megaphone } from 'lucide-react';
...
export default function FASBHome() {
    ...
    return (
        <div className="min-h-screen bg-[#050505] text-white">
            ...
            <header className="border-b border-white/5 bg-[#0a0a0a]/80 backdrop-blur-xl sticky top-0 z-50">
                <div className="max-w-6xl mx-auto px-6 py-4 flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-lg font-semibold text-white">FASB</h1>
            ...
            <main className="max-w-6xl mx-auto px-6 py-12">
                {/* Welcome Banner */}
                <div className="relative overflow-hidden rounded-2xl border border-orange-500/20 bg-gradient-to-br from-orange-600/10 to-amber-400/5 bg-[#0a0a0a] p-8 mb-10">
                    <div className="absolute -top-16 -right-16 w-48 h-48 bg-gradient-to-br from-orange-500 to-amber-500 opacity-[0.07] rounded-full blur-3xl" />
                    <div className="relative z-10">
                        <h2 className="text-3xl font-bold mb-2">Bem-vindo à FASB</h2>
                        ...
                        return (
                            ...
                            >
                                <div className="w-12 h-12 rounded-xl bg-orange-500/10 flex items-center justify-center mb-4">
                                    <Icone className="w-6 h-6 text-orange-400/50" />
                                </div>
