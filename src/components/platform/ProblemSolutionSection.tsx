      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {problems.map((problem, index) => (
            <GlassCard key={index} className="text-center border-red-500/20 bg-red-500/5">
        ...
        <div className="flex justify-center mb-16">
          <div className="w-px h-16 bg-gradient-to-b from-red-400/50 to-lime-400/50" />
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {solutions.map((solution, index) => (
            <GlassCard key={index} className="text-center border-lime-400/20 bg-lime-400/5">
              <div className="inline-flex p-3 rounded-xl bg-lime-400/10 mb-4">
                <solution.icon className="h-8 w-8 text-lime-400" />
              </div>
